...
defined("UPLOAD_PATH") || define('UPLOAD_PATH', DOCUMENT_ROOT.'public'.DS.'uploads'.DS.'');
defined("UPLOADS") || define('UPLOADS', URL.'public'.DS.'uploads'.DS.'');
defined("UPLOAD_PATH_THUMB") || define('UPLOAD_PATH_THUMB', DOCUMENT_ROOT.'public'.DS.'uploads'.DS.'thumb'.DS);
...
defined("EMAIL_TO") || define('EMAIL_TO', 'sandor@sandor.cu.cc');
